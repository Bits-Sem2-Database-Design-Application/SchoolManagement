...
public class ProgramCoursePK implements Serializable {
    ...
    public ProgramCoursePK(long programId, long courseId) {
    ...
    public String toString() {
        return "bits.pilani.sem2.dda.assignment1.entity.ProgramCoursePK[ programId=" + programId + ", courseId=" + courseId + " ]";
    }
